...
%  
 ...
 \item Propositional equality is not adequate for infinite objects
 \item[] $\qquad\leadsto$ bisimilarity
...
\begin{frame}
 \frametitle{Axioms for streams and bisimulation}
%   \begin{description}
%    \item []
...
~\\~\\
$+$ elimination for streams and $\bisim$\ldots
