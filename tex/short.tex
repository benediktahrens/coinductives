...
% \tableofcontents
 ...
 Here, we firstly identify those weak constructive comonads as an instance of the more general notion of \emph{relative comonad};
 ...
 Afterwards, we characterize this codata type, equipped with the cosubstitution operation of redecoration, as a terminal object of some category.
...
\end{figure}
  ...
  has a terminal object, given by the pair $(\Tri,\tail)$ of the relative comonad $\Tri$ and
  the comodule $\tail$ over that relative comonad.
% 
% 
% 
% 
