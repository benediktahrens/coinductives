...
\begin{block}{In this talk we consider}
  ...
  \begin{itemize} 
    \item codata types of \fat{streams} and infinite triangular \fat{matrices}
...
%  
 ...
 \item \enquote{Sameness} = bisimilarity
  \begin{center}
                                            \def\extraVskip{3pt}
     \def\proofSkipAmount{\vskip.8ex plus.8ex minus.4ex}
...
\begin{frame}
 \frametitle{Summary}
   ...
   \begin{itemize}\setlength{\itemsep}{1em}
    \item Coinductive type + bisimilarity as setoid
    \item $\stream$ and $\Tri$ as \fat{relative} comonad
%     \item Ad hoc notion of weak constructive comonad is instance of relative comonad
    ...
    \item Terminal algebra semantics for $\stream$ $\Tri$
