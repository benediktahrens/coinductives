...
For easier orientation, the table below gives the correspondance between the items in this article and
...
Tautological comodule && \Cref{def:tautological_comodule} &&\lstinline!tcomod!, \lstinline!< >!\\
