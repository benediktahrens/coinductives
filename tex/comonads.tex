...
\begin{abstract}
 ...
 use these notions to give a category-theoretical semantics for coinductive type families in 
...
\begin{example}[Relative comonads from comonads]\label{ex_relcom_from_com}
  Let $F : \C \to \D$ be a fully faithful functor and $(M,\counit,\cobind)$ be a (traditional) comonad on $\C$.
  ...
  \end{itemize}
  The proof of the axioms is immediate.
\end{example}
