...
\section{Introduction}
 ...
 two approaches to the semantics of inductive types are possible: 
 ...
 When a similar characterisation is possible, but some attention has to be given to 
...
%  
 ...
 More precisely, we prove, from rules for specific codata types added to the basic rules of Martin-L\"of type theory,
