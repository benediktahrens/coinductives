...
\end{Short}
 ...
 Categorically, \emph{bisimilarity} is given as the greatest---\emph{terminal}---\emph{relation} on the coinductive type that is compatible with the coalgebra structure.
