...
\begin{abstract}
  ...
  characterisation of infinite triangular matrices---equiped with the redecoration operation---as the \emph{terminal object}
  in some category.
...
\section{Introduction}
 ...
 has been extended to heterogeneous datatypes, e.g., the type of $\lambda$-terms,
 in various formulations \parencite{fpt, ahrens_relmonads}.
 In this work we give an analogous extension of this characterisation to an instance of heterogeneous \fat{co}inductive types,
...
Equivalently,
  \[ f   \mapsto \comp{\comp{\langle T(\pr_1) , T(\pr_2) \rangle}{(f\times\counit_E)}}{\alpha_{E,B}^{-1}} \enspace .
  \]
...
% TODO: cite abel's work on coinductive types through destructors
