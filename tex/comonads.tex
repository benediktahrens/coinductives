...
Let $E$ be an arbitrary fixed set.
    The type family $\Tri(A)$ of infinite triangular matrices over the (variable) type $A$ are given by the destructors shown in \Cref{fig:tri_destructors},
    ...
    underlying \emph{set}. However, the two inference rules of \Cref{fig:tri_destructors} are the only place this 
