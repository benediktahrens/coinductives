...
Maps into a coinductive data type are specified by the observations, i.e.\ the value of the destructors, on the output of those maps, as illustrated in \Cref{eq:tail_sredec}. The precise rule for specifying maps into a coinductive type is given in the appendix.
