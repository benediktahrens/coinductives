...
For the instantiation of the module type for $\Tri$, the formalization of infinite triangular matrices is taken from the work by Matthes and Picard \cite{DBLP:conf/types/MatthesP11},
...
\paragraph*{Acknowledgments}
 ...
 We thank the referees for their suggestions and comments, and the editors for making these proceedings happen.
