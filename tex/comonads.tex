...
\begin{ex}[Example \ref{ex_relcom_from_com} continued]\label{ex_relcom_from_com_morphism}
...
The proof of Theorem \ref{thm_stream_terminal} being essentially the same as that of Example \ref{ex:final_sem_tri}, we omit the former.
