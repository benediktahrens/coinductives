...
\title[]{Comodules over relative comonads for infinite triangular matrices}
...
\begin{abstract}
  ...
  In this work we study relative comonads and comodules over such comonads.
...
\section{The codata type of infinite triangular matrices}\label{sec:tri}

In this section we present a particular coinductive type family family in intensional Martin-L\"of type theory, the codata type of
infinite triangular matrices. It constitutes a source of examples for the categorical structures defined later.
...
%      \draw[color=green, dashed]  (2.8,-3.6) -- (3.5,-4.2);
 ...
 We define this data type \emph{coinductively}, via two destructors $\head$ and $\tail$, whose types are given in the first line of \Cref{fig:tri_destructors}.
