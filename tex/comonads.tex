...
\section{Introduction}
 ...
 We then use these notions to characterize two coinductive data types and their respective cosubstitution operations 
 in intensional Martin-L\"of type theory via a universal property: 
 firstly, we consider the \emph{homogeneous} codata type family of streams parametrized by a base type.
 Secondly, we consider the \emph{heterogeneous} codata type family of infinite triangular matrices parametrized by the type of diagonal entries.
...
\begin{Long} 
 \subsection{Cosubstitution is a comonadic operation on parametrized codata.}
\end{Long}
\begin{Short}
 \paragraph*{Cosubstitution is a comonadic operation on parametrized codata.}
\end{Short}
