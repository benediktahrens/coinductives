...
\end{Short}
 ...
 For instance, a natural number can be considered as such a tree: the possible nodes are $S$---a node with one subtree---and $Z$---a node without subtree, i.e.\ a \emph{leaf}.
