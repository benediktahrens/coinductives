...
\section{Introduction}
 ...
 We then use these notions to characterise several coinductive data types and operations on them in intensional Martin-L\"of type theory
 ...
 The codata types we consider come with a canonical \emph{cosubstitution operation}. In order to give a categorical characterisation
 of this operation, we develop the notion of \emph{comodule over a relative comonad}. More precisely, this notion is used to characterise the \emph{destructors} of the
 coinductive data types we consider: \emph{morphism of comodules} capture the interplay between 
