...
\begin{remark}[Category of comodules]
 ...
 Comodules over $T$ towards $\E$ and their morphisms (\Cref{def:morphism_of_comodules}) form a category.
\end{remark}
...
\begin{definition}[Pullback comodule]
...
Need functoriality of all the constructions on comodules in order for \Cref{ex:final_sem_tri} to make sense.
