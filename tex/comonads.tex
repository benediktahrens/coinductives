...
\begin{Short}
 ...
 There, we give details we had to omit from this version for reasons of space: 
  we show how to get relative comonads from (traditional) comonads, 
           ...
           give proofs of the lemmas in this work.
\end{Short}
...
\begin{example}\label{ex_stream}
  ...
  A map into streams is defined by specifying the observations---$\shead$ and $\stail$---on the output of that map.
  We use this principle rather informally in \Cref{eq:tail_sredec}, where we define a \emph{co}substition operation 
