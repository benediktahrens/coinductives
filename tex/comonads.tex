...
\title[Comodules over relative comonads for streams and infinite matrices]{Comodules over relative comonads \\ for streams and infinite matrices}
...
\begin{example}
  Let $A$ by a type. The type of \emph{streams over $A$} is coinductively defined via the following destructors:
  \begin{figure}[hbt]
  \begin{center}
...
% TODO: give example of Tri as rel. comonad
\end{example}
...
\begin{example}
%  TODO: is tail for streams a morphism of comonads?
\end{example}
...
As an application of comodules over relative comonads, we use that notion to
 define \fat{coalgebras} for the signature of infinite triangular matrices such that 
