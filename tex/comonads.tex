...
more precisely, of its behaviour with respect to cosubstitution as in \Cref{eq:rest_redec}---via the notion of comodule morphism:
...
In the other version we provide the axioms of \Cref{stream_rules} and \Cref{tri_rules} as written there,
