...
We consider some coinductive type families in Intensional Martin-L\"of type theory (IMLTT) \parencite{martin_lof}, 
...
\begin{definition}%[Coalgebras for $\stream$]
 \label{cat_stream}
  %Inspired by \Cref{ex_stream_comonad} and \Cref{ex_tail_comodule}, 
...
a terminal semantics for them, in line with the definitions we give for $\stream$, is trivial.
