...
\section{Introduction}
 ...
 The second one is the \emph{heterogeneous} codata type family of infinite triangular matrices parametrized by the type of diagonal entries.
  ...
  We then explain substitution for leaf-labeled trees and cosubstitution for node-labeled trees in \Cref{sec:cosubst}, and describe
  the difference between homogeneous and heterogeneous (co)data types in \Cref{sec:hom_het}.
...
T his variant forms the basis of the computer proof assistants \coq, \matita and \agda.
...
\begin{defn}\label{def:monoidal_functor}
...
\begin{rem}[Coalgebras for streams]\label{rem:coalg_stream}
 We define 
...
\begin{defn}%[Coalgebras of infinite triangular matrices]
\label{def:cat_tri}
   Let $E:\Set$ be a type.
